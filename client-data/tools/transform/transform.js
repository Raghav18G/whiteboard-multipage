...
(function transform() { //Code isolation
	...
	var selectionSVG = '<svg class="tool-icon-svg" viewBox="0 0 34 33" fill="none" xmlns="http://www.w3.org/2000/svg">g clip-path="url(#clip0_6289_33053)"><path d="M12.8707 27.3076L10.9919 9.32849C10.8413 7.88693 12.3693 7.00472 13.5425 7.85595L28.1734 18.4725C29.499 19.4344 28.992 21.5188 27.4197 21.571L20.731 21.7931C20.2107 21.8104 19.7427 22.0806 19.4676 22.5225L15.9309 28.2041C15.0995 29.5396 13.0409 28.9365 12.8707 27.3076Z" stroke="#1C274C" stroke-width="1.5"/></g><defs><clipPath id="clip0_6289_33053"><rect width="24" height="24" fill="white" transform="translate(0.375 12) rotate(-30)"/></clipPath></defs></svg><label class="label-tool" style="font-size:10px;font-weight:400;line-height: 2px; margin-top: 14px;"><p>Transform</p></label>';
